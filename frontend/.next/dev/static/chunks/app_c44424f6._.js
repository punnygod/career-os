...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].register(email, password);
...
_s(RegisterPage, "M9NJ2C4+hK6ccWYh9YTkFbfCSa8=", false, function() {
    return [
